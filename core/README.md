...
>
> For development work, i.e if the core stack is deployed via sam deploy, it is advised to disable `ObjectLock` and remove `ObjectLockConfiguration` so the dev file can be deleted once the ticket is complete.
